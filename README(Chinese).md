...
[OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) represents the **世界上首个在单张图片中识别人体躯干、手、脸部共135个关键点的多人实时识别系统**.

<p align="center">
    <img src="doc/media/pose_face_hands.gif", width="480">
</p>
本中文文档由同济大学的Tommy翻译整理
## 特点
- **功能**:
    - **二维多人关键点实时识别**:
        - 15、18或 **25个身体/脚部的关键点识别**. **运算时间与检测出的人数无关**.
        - **2*21个手部关键点识别**. 目前, **运算时间取决于** on **检测出的人数**.
        - **70个面部关键点的识别**. 目前, **运算时间取决于** on **检测出的人数**.
    - **三维单关键点实时识别**:
